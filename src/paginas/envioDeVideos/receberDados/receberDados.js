...
import FormularioEnvioVideos from "../formulario/formularioEnvioVideos.js"
...
const ReceberDados = () => {
    ...
    const times = [
      ...
      const inicial = [
        { id: uuidv4(), titulo: 'JULIANA AMOASEI', cargo: 'Desenvolvedora de software e instrutora', imagem: 'https://www.alura.com.br/assets/img/lideres/juliana-amoasei.1647533644.jpeg', time: times[0].nome },
